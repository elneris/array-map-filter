...
function getActivitiesMembers(activities, persons) {  
  var allActivities = [];
  activities.forEach(function(oneActivity, index){
    var activity = new Object;
    activity['activity'] = oneActivity;
    activity['persons'] = persons.filter(person => person.activities.includes(oneActivity)).map(person => person.name);
